...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        {
          name: 'Сертифікат щодо прохождення тренінга',
          id: '2465',
        },
        {
          name: 'Сертифікат водія',
          id: '5780',
        },
        {
          ...
          projects: [
            {
              ...
              about: `High-load application for searching apartment`,
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                ...
                {
                  name: `Preraring SEO optimized pages. The automated process of getting data for the app from documents.`,
                },
              ],
              awardAmount: 2,
            },
